...
@Action(value = "departmentAction", results = {
		@Result(name = "add", location = "/department/addDepartment.jsp"),
		@Result(name = "update", location = "/department/updateDepartment.jsp"),
		@Result(name = "text", type = "stream", params = { "contentType",
				"text/html", "inputName", "inputStream" }),
		@Result(name = "pagination", location = "/department/listDepartment.jsp"),
		@Result(name = "department", location = "/department/updateDepartment.jsp"),
...
public class DepartmentAction extends ActionSupport implements
	...
	public String update() {
		department = departmentService.findDepartment(department
				.getDepartmentId());
		return "update";
	}
