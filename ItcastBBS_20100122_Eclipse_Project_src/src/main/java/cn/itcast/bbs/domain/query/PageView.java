...
public class PageView {
	...
	static {
		...
		EMPTY_PAGE_VIEW.setPageSize(DataDict.getInt(DDConstants.DEFAULT_PAGE_SIZE));
	...
	public PageView(int currentPage, int pageSize, int recordCount, List recordList) {
		...
		// 分页信息中要显示的页码的数量
		int dispalyPageNumberCount = DataDict.getInt(DDConstants.DISPALY_PAGE_NUMBER_COUNT);
