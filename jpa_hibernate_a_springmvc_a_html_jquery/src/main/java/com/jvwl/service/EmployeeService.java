...
public class EmployeeService extends BaseService<Employee> {
	...
	public void delete(Serializable[] ids) {
		super.delete(Employee.class, ids);
	}
	...
	public Employee findClass(Serializable id) {
		return super.findClass(Employee.class, id);
	}

	public Employee findByEmployeeId(String id) {
		String jpql = "from Employee e where e.emp_id=?";
		List<Employee> list = query(jpql, new PageInfo(1, 1),
				new Object[] { id });
	...
	public Pagination<Employee> findEmployees(EmployeeDTO emp, PageInfo pageInfo) {
		...
		Pagination<Employee> pagination = new Pagination<Employee>(null,
