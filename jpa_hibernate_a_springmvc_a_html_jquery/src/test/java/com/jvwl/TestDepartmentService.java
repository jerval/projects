...
public class TestDepartmentService {
	...
	public void testDeleteClassOfTSerializableArray() {
		departmentService.delete(new Serializable[] { 2 });
	}
	...
	public void testFind() {
		System.out.println(departmentService.find(1));
	}

	@Test
	public void testFindClass() {
		System.out.println(departmentService.findClass(2));
	}

	@Test
	public void testGetTotalElements() {
		System.out.println(departmentService.getTotalElements(
				"select count(*) from Department d where id>?", 1));
	}
