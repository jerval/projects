$(function() {
			...
			$("input[name='add']").click(function() {
						location.assign("employee_add.html");
					});
			...
			$("input[name='update']").click(function() {
						...
						if (ids.length == 1) {
							location.assign("employee_edit.html?id=" + ids[0]);
							return;
						}
					});
			$("input[name='detail']").click(function() {
						...
						if (ids.length == 1) {
							location
									.assign("employee_detail.html?id=" + ids[0]);
							return;
						}
					});
			$("input[name='delete']").click(function() {
						...
						if (confirm("您确定要删除这" + ids.length + "条数据吗？")) {
							var url = "employeeEditAction!delete?";
