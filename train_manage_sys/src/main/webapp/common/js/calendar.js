...
*/
  ...
  function AddItem(id,name,parent,location)
  {
    ...
    {
      TempStr += " onclick='window.event.cancelBubble=true;SelectUser(\""+location+"\",\""+name+"\");'";
  ...
  function OnClick()
  {
      if (document.conferenceEditForm.currCmbUserList != null)
      {
          HideAll("rbpm",0);
      }
  }
  ...
  {   
      if(userid!=""){
   	      document.all.peopleId.value=userid;
  	      document.all.bookingPeople.value=name;
	  }
	  else{
	      document.all.peopleId.value="";
  	      document.all.bookingPeople.value="";
	  }
      fHideCalendar();
      //OnClick();
  }
